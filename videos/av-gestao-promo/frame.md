...
colors:
  ...
  bg-elevated: "#141d33"
  primary: "#3a6df5"
  primary-bright: "#5b86ff"
  text: "#ffffff"
  text-muted: "#aab4cc"
  text-light: "#6b7591"
  accent-light: "rgba(58, 109, 245, 0.10)"
  accent-medium: "rgba(91, 134, 255, 0.20)"
  border: "rgba(120, 150, 220, 0.22)"
  card-bg: "rgba(58, 109, 245, 0.08)"
  positive: "#34d399"
  negative: "#f87171"
...
components:
  ...
  cta-button:
    ...
    shadow: "soft blue glow — the system's only glow, matches the dark hero"
    description: "The one solid element — blue pill, white label."
  accent-line:
    backgroundColor: "{colors.primary}"
...
- **GROUND IS DARK NAVY, NOT CREAM.** This is AV Gestão Financeira's signature hero look. Every frame ground is `{colors.bg}` **#0b1120 navy-deep** (optionally lifting to `{colors.bg-elevated}` #141d33). Wherever the prose below says "cream" / "warm cream ground" / "near-black headline", read it inverted: the ground is deep navy, **headlines are white** (`{colors.text}` #ffffff), body is light slate (`{colors.text-muted}`), and the **vibrant blue** (`{colors.primary}` #3a6df5, glow via `{colors.primary-bright}`) is the single accent — eyebrows, numerals, CTA, bars, progress. Blue radial glows on the navy ground are on-brand (the hero uses them). Never place dark text on the navy ground.
