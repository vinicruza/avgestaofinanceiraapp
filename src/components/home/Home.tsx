...
function Hero() {
  return (
    <section className="relative hero-bg overflow-hidden">
      ...
      <div className="relative mx-auto grid max-w-[1360px] grid-cols-1 gap-10 px-6 pb-24 pt-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)] lg:gap-8 lg:px-10 lg:pt-10">
